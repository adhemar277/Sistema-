-- 1. Borrar la tabla anterior para actualizar la estructura
DROP TABLE IF EXISTS attendance CASCADE;

-- 2. Crear la nueva tabla de Asistencia y Vacaciones (Mensual)
CREATE TABLE attendance (
    ...
    total_vacation_days INTEGER DEFAULT 4,
